...
/**
 * Global bootstrap (Option A): install AJP once, globally, and have agents
 ...
 * That rule tells the agent: "if a repo has no `.agent/`, run `ajp setup`." So
...
export const GLOBAL_AGENT_FILES: Array<{
  ...
  { rel: ".config/ajp/AGENTS.md", dir: ".config/ajp", agent: "generic", primary: true },
];
